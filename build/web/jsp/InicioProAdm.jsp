...
<html>
  ...
  <meta http-equiv="Pragma" content="no-cache">
    ...
    <body style="background-color: black;" onload="ValidarInfoUsuario(3);">
        ...
        <!-- INICIO MODAL Catálogo DE CURSOS -->
            ...
            <center>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 10%;margin-top: 15%">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"style="margin-bottom: 10%;">            
                        <a style="text-decoration:none;color:#990000" href="/GestionDeCursos/jsp/GestorDeCursos/GestorDeCursosProAdm.jsp">
                        <div class="div-img" >
...
<a style="text-decoration:none;color:#990000" data-toggle="modal" data-target="#ModalCatCursos" href="#" >
                        <div class="div-img" >
                                <img class="img" src="/GestionDeCursos/Imagen/Iconos/CatalogoCursos.png" title="Catálogo" alt="Foto4"style="width: 35%; margin: 0">
