...
<html>
  ...
  <meta http-equiv="Pragma" content="no-cache">
    ...
    <body style="background-color: black;" onload="ValidarInfoUsuarioGesPro(2);">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10" style="background-color: white;height:100%;overflow-y: auto;margin-bottom: 0;padding: 0;overflow-x: hidden;">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0">
                    <div class="row" >
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><br>
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <b><span style="color:#990000"><a style="color: #990000" href="/GestionDeCursos/jsp/InicioPro.jsp">Inicio </a>/ Estas aquí</span></b>
                    </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
