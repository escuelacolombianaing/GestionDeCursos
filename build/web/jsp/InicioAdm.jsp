...
<html>
    <head>
        ...
        <script src="/GestionDeCursos/js/jsonh.js"></script>
    ...
    <body style="background-color: black;" onload="ValidarInfoUsuario(1);" >
        ...
        <!-- INICIO MODAL CERTIFICADOS DE CURSOS -->
        ...
        <!-- FIN MODAL CERTIFICADOS DE CURSOS -->
        ...
        <div id="ModalCatCursos" class="modal fade" style="overflow-y: auto;">
            ...
            <div class="md-modal md-effect-4" id="modal-4Rechazado" tabindex="-1" style="z-index: 2;background-color: transparent;position: fixed;" >
                ...
                <div class="md-content" style="background-color: transparent;">
                    ...
                    <center>   
                        <img class="md-close" aria-hidden="true" class="img" id="Imgrechazado" src="/GestionDeCursos/Imagen/Iconos/cruzar.png" title="Catalogo" alt="Foto4"style="width: 35%;">   
            ...
            <div class="md-modal md-effect-4" id="modal-4" tabindex="-1" style="z-index: 2;background-color: transparent;position: fixed" >
                ...
                <div class="md-content" style="background-color: transparent;">
                    ...
                    <center>   
                        <img class="md-close" aria-hidden="true" class="img" id="ImgAprobado" src="/GestionDeCursos/Imagen/Iconos/garrapata.png" title="Catalogo" alt="Foto4"style="width: 35%;">   
                ...
                <div class="modal-dialog" style="width: 90%;">
                    <div class="modal-content col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-x: scroll"><br>
                            ...
                            <form method="POST" action="" id="myFormHome">
                                <table data-toggle="toggle" id="myTableCatalogo" class="table table-bordered table-striped" style="width:100%">
            ...
            <center>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 10%;margin-top: 15%">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"style="margin-bottom: 10%;">       
                        <a style="text-decoration:none;color:#990000" href="/GestionDeCursos/jsp/GestorDeCursos/GestorDeCursos.jsp">                    
                            <div class="div-img" >
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"style="margin-bottom: 10%" >
                        <a style="text-decoration:none;color:#990000" data-toggle="modal" data-target="#ModalCertificados"  href="#">
                            ...
                            <div class="div-img" ><img class="img" src="/GestionDeCursos/Imagen/Iconos/Certificados.png" title="Certificados" alt="Foto4" style="width: 35%">


                            </div>
                            <div class="text"><br><b>Certificados</b></div>
                        </a>
