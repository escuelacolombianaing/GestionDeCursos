...
<html>
  ...
  <meta http-equiv="Pragma" content="no-cache">
    ...
    <body style="background-color: black;" onload="ValidarInfoUsuario(4);">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0">
            ...
            <center>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 10%;margin-top: 15%">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"style="margin-bottom: 10%" onclick="ListaCursosInscribirse();" >
